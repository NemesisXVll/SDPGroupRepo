						  ...
						  <div className="mt-7">
							  {location.pathname === "/otp" && (
								  <p className="text-sm text-gray-600 mb-2">
									...
									<div className="border border-gray-300 p-4 rounded-lg shadow-md">
										...
										<select
											...
											className="w-full bg-gray-900 text-white border rounded-lg  font-medium mb-1 mt-3 text-center"
								  ...
								  >
									...
									<div className="border border-gray-300 p-4 rounded-lg mt-3 shadow-md">
										<p className="text-gray-800 pt-3 font-medium">
											{" "}
											Select Question 2
										</p>
										<select
											className="w-full p-2 bg-gray-900  text-white border font-medium rounded-lg mb-1 mt-3 text-center"
