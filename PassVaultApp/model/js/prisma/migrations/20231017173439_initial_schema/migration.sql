...
CREATE TABLE "CREDENTIAL" (
    ...
    "CREDENTIAL_MEDIATYPE" TEXT NOT NULL DEFAULT 'Personal',
    "CREDENTIAL_PICTURE" BLOB,
    "CREDENTIAL_ISFAVOURITE" BOOLEAN NOT NULL DEFAULT false,
    "TRASH_ID" INTEGER NOT NULL,
    "USER_ID" INTEGER NOT NULL,
    CONSTRAINT "CREDENTIAL_TRASH_ID_fkey" FOREIGN KEY ("TRASH_ID") REFERENCES "TRASH" ("TRASH_ID") ON DELETE RESTRICT ON UPDATE CASCADE,
